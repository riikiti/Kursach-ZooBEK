            ...
            if ($result = mysqli_query($link, $sql)) {
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        //var_dump($free_tour);
                        $tour_card_disabled = 'tours-card-disabled';
                        $disabled = 'disabled';
                        ...
                        if ($_SESSION['user']['id'] != NULL) {
                            if ($tour_count > 0) {
                                ...
                                echo "<img src='$image'>";
                                echo "<div class='tours-card-content'>";
                                ...
                                echo " <span class='tours-date'>$tour_date</span>";
                                echo "  <span class='tours-date'>Свободно :  $free_tour  мест</span>";
