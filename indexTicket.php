        ...
        <div class="container-fluid mt-5">
            ...
            if ($result = mysqli_query($link, $sql)) {
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<tr>";
                    echo "<th  class='border-end'>id_tour</th>";
                    echo "<th  class='border-end'>tour_name</th>";
                    echo "<th  class='border-end'>tour_date</th>";
                    echo "<th  class='border-end'>tour_count</th>";
                    echo "<th  class='border-end'>tour_photo</th>";
                    echo "<th  class='border-end'>Action</th>";
                    echo "</tr>";
                    echo "</thead>";
                    echo "<tbody>";
                    while ($row = mysqli_fetch_array($result)) {
                        echo "<tr>";
                        echo "<td class='border-end'>" . $row['id_tour'] . "</td>";
                        echo "<td class='border-end'>" . $row['tour_name'] . "</td>";
                        echo "<td class='border-end'>" . $row['tour_date'] . "</td>";
                        echo "<td class='border-end'>" . $row['tour_count'] . "</td>";
                        echo "<td class='border-end'>" . $row['tour_photo'] . "</td>";

                        echo "<td><a href='vendorAdmin/deleteTicket.php?id=" . $row['id_tour'] . "' title='Удалить'>";
                    ...
                    echo "<p class='lead'><em>Не найдено никаких билетов</em></p>";
                }
            } else {
